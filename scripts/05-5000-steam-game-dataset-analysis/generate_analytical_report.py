...
# This allows the SQL (the "what") to be developed, tested, and maintained independently of the
# Python orchestration logic (the "how").
...
def process_and_visualize(title: str, df: pd.DataFrame) -> str:
    ...
    try:
        ...
        # Forgetting plt.close() in a loop can lead to memory leaks.
    ...
    try:
        ...
        for query_block in queries:
            ...
            try:
                ...
                # load the results directly into a structured DataFrame, handling data types.
                ...
                # to ensure a clean connection state.
