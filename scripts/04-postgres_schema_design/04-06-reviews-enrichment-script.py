# =====================================================================================================================
# Script Name:    enrich_with_reviews.py
# Description:    A resilient, resumable script to enrich the existing dataset with review data. It reads
#                 a list of successfully processed appids, calls the 'appreviews' API endpoint for each,
#                 and saves the review data in separate, batched files. This is designed to run in parallel
#                 with the main data collection, using a secondary API key.
#
...
# License:        MIT License
#
# Usage:          Run the script from the project's root directory. It will automatically use the
#                 'state/' directory as input and create a 'data_reviews/' directory for output.
#                 Example: python enrich_with_reviews.py
#
# =====================================================================================================================
