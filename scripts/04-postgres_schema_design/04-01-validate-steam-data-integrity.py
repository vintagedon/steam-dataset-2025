# =====================================================================================================================
# Script Name:    validate_data_integrity.py
# Description:    A utility to validate the schema and data integrity of a Steam API JSON data file.
#                 It checks for structural correctness, data consistency, and adherence to expected
#                 business rules, producing a detailed report to certify the data's readiness for import.
#
...
# License:        MIT License
#
# Usage:          Run the script from the command line in a directory containing .json data files.
#                 It will prompt you to select which file to validate.
#                 Example: python validate_data_integrity.py
#
# =====================================================================================================================
...
#   --------------- --------------- --------------- -------------------------------------------------------------------
#   2025-08-31      1.0             vintagedon      Initial release with core validation checks.
#   2025-08-31      1.1             vintagedon      Enhanced reporting to include a validation checklist and a
#                                                   detailed data profile with representative samples.
# =====================================================================================================================
