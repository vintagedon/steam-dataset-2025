...
#                 and provides a safe, interactive mechanism for recreating databases.
#
...
#   --------------- --------------- --------------- -------------------------------------------------------------------
#   2025-08-31      1.1             vintagedon      Initial refactored release with decoupled schema and --recreate flag.
#   2025-08-31      1.2             vintagedon      Bugfix: Added explicit user creation step.
#   2025-08-31      1.3             vintagedon      Bugfix: Added GRANT role membership to admin user to allow
#                                                   assigning ownership during database creation.
# =====================================================================================================================
