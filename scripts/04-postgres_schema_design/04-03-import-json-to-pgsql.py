# =====================================================================================================================
# Script Name:    import_json_to_pg.py
# Description:    An ETL script to load an enriched JSON dataset from the Steam API into the normalized
#                 PostgreSQL database. It handles data transformation, populates all lookup, main, and
#                 junction tables, and ensures the entire process is transaction-safe.
#
...
#                 Direct:   python import_json_to_pg.py <database_name> <input_json_file>
#                 Interactive: python import_json_to_pg.py
#
# =====================================================================================================================
...
#   --------------- --------------- --------------- -------------------------------------------------------------------
#   2025-08-31      1.1             vintagedon      Bugfix for missing junction table population logic.
#   2025-09-01      1.2             vintagedon      Feature: Added complete logic to parse and import review data
#                                                   into the 'reviews' table, completing the ETL process.
# =====================================================================================================================
